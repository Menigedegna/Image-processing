...
#    <CustomTools>
#      <Menu>
#       <Item name="NucleiPloidyPollen" icon="Python" tooltip="NucleiPloidyPollen">
#         <Command>PythonXT::XTNucleiPloidyPollen(%i)</Command>
#       </Item>
#      </Menu>
#    </CustomTools>
...
#==============================================================================
        ...
        SurfPollen=Segment_Surface(vImage, DAPIChannel, 0.8, "Pollen Grain",10, None) # Segment pollen
        vSigma                      =    0.15
        ...
        SurfNucleus=Segment_Surface(vImage, DAPIChannel, 0.2, "Nuclei",1.15, 1) # Segment nuclei
        ...
        positionOfAllItemsPollen      =   [SurfPollen.GetCenterOfMass(surfId)[0] for surfId in range(NumberOfSurfacesPollen)]
        positionOfAllItemsNuclei      =   [SurfNucleus.GetCenterOfMass(surfId)[0] for surfId in range(NumberOfSurfacesNuclei)]
...
#==============================================================================
        ...
        ListOuput=[VolumeListPollen, IntensityListPollen, VolumeListNuclei, IntensityListNuclei, positionOfAllItemsPollen, positionOfAllItemsNuclei]
        OuputTtile=["PollenArea", "PollenIntensity", "NucleiVolume", "NucleiIntensity", "PositionPollen", "PositionNuclei"]
...
# Process images
#==============================================================================
def XTNucleiPloidyPollen(aImarisId):
    logging.basicConfig(level=logging.DEBUG, filename= "log[XTNucleiPloidyPollen].log")
    try:
